    ...
    $('#subscribeHandlerSettings').on('click', function() {
        socket.getDBValues('alerts_subscribe_get_settings', {
            ...
            keys: ['subscribeMessage', 'primeSubscribeMessage', 'reSubscribeMessage', 'giftSubMessage', 'subscriberWelcomeToggle', 'primeSubscriberWelcomeToggle',
                    ...
                    'massGiftSubWelcomeToggle', 'massGiftSubMessage', 'massGiftSubReward']
        }, true, function(e) {
            ...
            // Append forth collapsible accordion.
            .append(helpers.getCollapsibleAccordion('main-5', 'Mass Gifted Subscription Settings', $('<form/>', {
                    'role': 'form'
                })
                // Add toggle for gifted subscriptions.
                .append(helpers.getDropdownGroup('mass-gifsub-toggle', 'Enable Mass Gifted Subscription Alerts', (e.massGiftSubWelcomeToggle === 'true' ? 'Yes' : 'No'), ['Yes', 'No'],
                    'If a message should be said in the channel when someone gifts a subscription. This also toggles the reward.'))
                // Append message box for the message
                .append(helpers.getTextAreaGroup('mass-gifsub-msg', 'text', 'Mass Gifted Subscription Message', '', e.massGiftSubMessage,
                    'Message said when someone resubscribes to the channel. Tags: (name), (plan), (amount), and (reward)', false))
                // Appen the reward box
                .append(helpers.getInputGroup('mass-gifsub-reward', 'number', 'Mass Gifted Subscription Reward', '', e.massGiftSubReward,
                    'Reward given to the user who bought the subscription. This is a multiplier. (reward * amount gifted)'))))
            // Tier settings
            .append(helpers.getCollapsibleAccordion('main-6', 'Tier Settings', $('<form/>', {
                    'role': 'form'
                })
            ...
            function() { // Callback once the user clicks save.
                let subToggle = $('#sub-toggle').find(':selected').text() === 'Yes',
                    ...
                    massGifSubToggle = $('#mass-gifsub-toggle').find(':selected').text() === 'Yes',
                    massGifSubMsg = $('#mass-gifsub-msg'),
                    massGifSubReward = $('#mass-gifsub-reward'),
                    tierOne = $('#sub-1000'),
                    tierTwo = $('#sub-2000'),
                    tierThree = $('#sub-3000');
                ...
                switch (false) {
                    ...
                    case helpers.handleInputString(massGifSubMsg):
                    case helpers.handleInputNumber(massGifSubReward, 0):
                    ...
                    default:
                        socket.updateDBValues('alerts_subscribe_update_settings', {
                            ...
                            values: [subMsg.val(), primeSubMsg.val(), reSubMsg.val(), gifSubMsg.val(), subToggle, primeSubToggle, reSubToggle, gifSubToggle, subReward.val(), reSubReward.val(),
                                gifSubReward.val(), reSubEmote.val(), tierOne.val(), tierTwo.val(), tierThree.val(), massGifSubToggle, massGiftSubMessage.val(), massGiftSubReward.val()]
                        }, function() {
