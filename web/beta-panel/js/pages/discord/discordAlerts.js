...
$(function() {
    ...
    socket.getDBValues('alerts_get_modules', {
        tables: ['modules', 'modules', 'modules', 'modules', 'modules', 'modules', 'modules', 'modules', 'modules', 'modules', 'modules', 'modules', 'modules'],
        keys: ['./discord/handlers/followHandler.js', './discord/handlers/subscribeHandler.js', './discord/handlers/hostHandler.js',
        		...
        		'./discord/handlers/gamewispHandler.js', './discord/handlers/twitterHandler.js', './discord/handlers/streamHandler.js']
    }, true, function(e) {
...
$(function() {
    ...
    $('#discordHostHandlerSettings').on('click', function() {
        socket.getDBValues('alerts_get_host_settings', {
            ...
            .append(helpers.getDropdownGroup('host-toggle', 'Enable Host Alerts', (e.followToggle === 'true' ? 'Yes' : 'No'), ['Yes', 'No'],
                'If a message should be said in the channel when someone follows.'))
