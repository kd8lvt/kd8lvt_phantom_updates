...
$(function() {
    ...
    // Panel version.
    helpers.PANEL_VERSION = '1.2 (BETA)';
    ...
    helpers.handleDarkMode = function(isDark, isAtLoadUp) {
        ...
        if (isDark) {
            ...
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/vendors/adminlte/css/AdminLTE.dark.min.css'
            }));

            // skins.
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/vendors/adminlte/css/skins/skin-purple.dark.min.css'
            }));
            ...
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/vendors/adminlte/css/AdminLTE.min.css'
            }));

            // skins.
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/vendors/adminlte/css/skins/skin-purple.min.css'
            }));
